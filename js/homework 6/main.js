...
//         console.log(`довжина ${arr[i]}:${arr[i].length}`);
//     }
// }
// foo(arr);
...
// ];
//
// console.log(coursesAndDurationArray.filter((value, index) => {
...
// }));
// console.log(cards.filter((value,index) => {
//     if(value.value !== '6' && value.value !== '7' && value.value !== '8'){
//         return 1;
//     }
// }));
//
